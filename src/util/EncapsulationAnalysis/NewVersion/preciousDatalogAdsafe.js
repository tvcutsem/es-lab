 ...
 * Assumes:
 */
 this.genPreciousConstraints = function genDatalogPreciousConstraints(encodeVar, encodeField, encodeLoc,encodeCon) {
 
     var constraint = "	  Precious(l) :- Precious(n), HPtsTo(l," + encodeField('$A$AdsafeRejectNot') + ",n). \n";    
     return constraint;
