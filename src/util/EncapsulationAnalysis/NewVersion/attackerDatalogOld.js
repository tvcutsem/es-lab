...
//	 "Precious(l) :- Precious(n), HPtsTo(l," + encodeField('$A$AdsafeRejectNot') + ",n). \n" ;
	 ...
	 relName('formalArg') + "(" + attackerFuncNum+ "," + "i," +attackerLocalNum+").\n" +
	
	 relName('formalRet') + "(" + attackerFuncNum+ "," +attackerLocalNum+").\n" +
	 ...
	 relName('hActualEverythingCon') + "(l,i,m,"+attackerLocalNum + "," + attackerConNum + "," + attackerCallSite + ") :- " + relName('aPtsTo') + "(l)" + " , " +  relName('aPtsTo') + "(m).\n" +
