 ...
 */
 this.genDOMConstraints = function genDOMConstraints(cloneFlag, encodeVar, encodeField, encodeLoc, getNextTempVar, getNextAstNumber, astNumberMap, relName, makeConstraint,  functionClones, nClones, maxArity) {
...
//	 retConstraints.push(makeConstraint('formalArg', [domFuncNum,0,'this_'+methName]));
	// retConstraints.push(makeConstraint('assign',[tempVar, 'this_'+methName]));
	 ...
	 constraint = makeConstraint('vPtsTo',['window_0_1',domObjNum]);
	 retConstraints.push(constraint);
