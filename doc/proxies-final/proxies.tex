...
\begin{tabular}{|p{0.20\textwidth}|p{0.80\textwidth}|}
    \hline
    \multicolumn{2}{|l|}{\textbf{Types of values that can be virtualized:}}\\
    \hline
    JS proxies        & Objects and functions, not primitives\\
    Java proxies      & Objects whose static type is an interface or \texttt{Object}, not primitives\\
    ...
    \hline
    \multicolumn{2}{|l|}{\textbf{Stratification: is the API stratified?}}\\
    \hline
    ...
    \hline
    \multicolumn{2}{|l|}{\textbf{Temporary Intercession: can intercession be limited in time?}}\\
    \hline
    ...
    \hline
    \multicolumn{2}{|l|}{\textbf{Meta-level shifting: can one shift meta-levels?}}\\
    \hline
    ...
    \hline
    \multicolumn{2}{|l|}{\textbf{Meta-level funnelling: can all operations be funnelled through a single trap?}}\\
    \hline
    ...
    \hline
    \multicolumn{2}{|l|}{\textbf{Selective interception: are there some operations applicable on proxies that cannot be intercepted?}}\\
    \hline
    ...
    \hline
    \multicolumn{2}{|l|}{\textbf{Fundamental vs. Derived Traps: does the API make this distinction?}}\\
    \hline
    ...
    \hline
    \multicolumn{2}{|l|}{\textbf{Handler Encapsulation: is the handler encapsulated?}}\\
    \hline
    JS proxies        & Yes\\
    ...
    ST \texttt{doesNotUnderstand:}  & No, proxy and handler are the same object\\
    \hline
    \multicolumn{2}{|l|}{\textbf{Uniform intercession: can all types of values in the language be virtualized?}}\\
    \hline
