...
% TODO: importance of encapsulated handler -> mirrors -> go through a separate 'mirror factory'

% TODO: should we discuss this in detail?
...
% TODO: link to the two-body problem
...
% TODO: shorten and integrate with Section 5.1 or move to Section 4 (not in related work)
...
\begin{itemize}
  ...
  \item Meta-level shifting and meta-level funneling
  \item Temporary intercession: dealing with immutability.
\end{itemize}

\section*{Acknowledgements}

We would like to thank the members of the ECMA TC-39 committee and the readers of the \texttt{es-discuss@mozilla.org} mailing list for their comments and feedback on our Proxy API. In particular, we would like to thank Brendan Eich, Andreas Gal and Dave Herman for their detailed comments and Andreas Gal for his work on the Tracemonkey implementation.
