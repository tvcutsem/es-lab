...
An \texttt{EphemeronTable} is a special kind of weak-key hashtable. It is based on Smalltalk's Ephemerons~\cite{et_paper} and is a new data type proposed for inclusion in ES-Harmony~\cite{miller10et}.
...
Unfortunately, implementing these maps in Javascript is impossible without introducing severe memory leaks. Ephemeron tables are a proposed language feature for the upcoming Ecmascript standard that address this issue~\cite{miller10et}.
