...
\subsection{Trapping method invocations}
% Get+Call versus Invoke
% var f = o.m; f.apply(o, [1, 2, 3]);
% o.m(1,2,3)
...
% Design principle: tradeoff between distinction of semantically equivalent code, but precisely because we reveal the distinction to proxies, we allow them to break the invariant
