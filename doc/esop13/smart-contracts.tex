...
The following four lines all define a one parameter function which returns twice its parameter. All bind a local variable named ``{\tt twice}'' to this function. This paper uses only the arrow function syntax of the last three lines.
