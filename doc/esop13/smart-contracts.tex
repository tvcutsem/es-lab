...
If this outcome promise becomes fulfilled, the exchange succeeded,  she should expect her {\tt a.moneySrcP} to be drained, and 7 shares of stock to have been deposited into her {\tt a.stockDstP}. If this promise becomes rejected, the exchange failed, and she should expect her \$10 to promptly\footnote{
%
``promptly'' in this usage might still be arbitrarily delayed by certain crashed machines and network partitions. This particular case is prompt once the money issuer is reachable from the escrow exchange agent.
%
} reappear in her {\tt a.moneySrcP}. In the meantime, if she gets impatient and would rather not continue waiting, she can call her {\tt cancel} function with her alleged reason for walking away. Once she does so, the exchange will then either succeed or fail promptly.\footnote{
%
