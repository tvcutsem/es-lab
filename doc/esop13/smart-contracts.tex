...
%
By "promptly", we mean, once the relevant machines are up, processes restarted, and reachable to each other over the network.
%
...
\bnote{Mark}{write acks: Cajadores, Tyler Close, TC39, Terence Kelley, Kris Kowal, Terry Stanley}
