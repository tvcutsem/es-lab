...
%
``promptly'' in this usage might still be arbitrarily delayed by crashed machines and partitioned networks. This particular case is prompt once the money issuer is reachable from the escrow exchange agent.
%
