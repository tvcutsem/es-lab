...
\begin{verbatim}
  ...
  foo(...[3, 5])            // ES6 rest args, as used in this paper
\end{verbatim}
...
\begin{itemize}
\item Records were fully mutable, allowing one client of the point to, for example, replace its {\tt getX} method, violating the assumptions of other clients. ES5 provides a {\tt freeze} primitive, used by the SES library to define the {\tt def} function for making a tamper proof object graph.
