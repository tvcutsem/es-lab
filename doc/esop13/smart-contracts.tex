...
\bnote{Mark}{It would be great if we could place this graphic into the figure without it taking up more vertical space. Unfortunately, two columns won't do because of the long line of text near the bottom. Failing that, it would be good to flow the following text around it, but I couldn't figure that out either.} 
